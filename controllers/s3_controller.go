...
func (r *S3Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	policyOutput, err := r.IAMClient.CreatePolicy(policyName, "Generated by s3-operator", s3Object.Spec.BucketName)
	...
	err = r.IAMClient.AttachPolicy(user, *policyOutput.Policy.Arn)
