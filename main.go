...
func init() {
	...
	utilruntime.Must(systeknov1.AddToScheme(scheme))
...
func main() {
	...
	output, _ := os.LookupEnv("AWS_SECRET_ACCESS_KEY")
	output2, _ := os.LookupEnv("AWS_ACCESS_KEY_ID")
	fmt.Println(output)
	fmt.Println(output2)
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "10aaa98b.systek.no",
	})
	if err != nil {
